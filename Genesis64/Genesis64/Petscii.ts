...
class Petscii {
	 ...
	 */
	public static PetToBas(pet: Array<number>): string {
	 ...
	 * @param text		string
	 */
	public static BasToPet(text: string): Array<number> {

		let pet: Array<number> = [];
	...
	public static BasToHtml (text: string, useLower:boolean = false): string {
		...
		const pet: Array<number> = this.BasToPet(text);
